...
S3FileUpload is libray for upload any type of files to Amazon AWS S3 (React version)
...
S3FileUpload
    .uploadFile(file, config, fileConfig)
...
S3FileUpload
    .deleteFile(filename, config, fileConfig)
